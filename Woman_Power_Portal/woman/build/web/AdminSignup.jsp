    ...
    <body class="backgroundformat">
        <table cellpadding="10" cellspacing="0" border="0" width="100%">
            ...
            <tr><td colspan="2" align="center">
                    ...
                    <form method="post" action="confirmAdminsign.jsp">
                        
                        <table cellpadding="10" cellspacing="0" border="0" width="90%" bgcolor='lightblue'>
                            
                            <tr bgcolor="red">    <td colspan="4" align="center"><b>ADMIN SIGN UP</b></td>   </tr>
                            <tr>    <td width='25%'></td><td>Enter Name</td><td><input type="text" name="txt_name" required="required"></td><td width='25%'></td>    </tr>
                                    <tr>    <td></td><td>Enter Address</td>
									<td>
								...
								<td></td>    </tr>
                                    ...
                                    <tr>    <td></td><td>Enter Email</td><td><input type="text" name="txt_email" required="required" id="txt_email" onblur="return validateEmailId()" onkeyup="checkExistingId()" id="info"></td><td></td>    </tr>
